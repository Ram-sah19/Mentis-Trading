    ...
    return ( 
        <div className='container'>
            <div className='row p-5 mt-5 '>
                <h1 className='fs-3 text-center'> We pioneered the discount broking model in india.<br/> Now, we are breaking ground with our rechnology. </h1>
            </div>
            <div className='row p-5 border-top mt-5 text-muted' style={{margin:"6%", fontSize:"17px",lineHeight:"32px", lineWidth:"15px"}}>
                ...
                <div className='col-6 mt-5 '>
                    ...
                    <p>In addition, we run a number of popular open online hilosophies saying about us or learn more about our business and product <a href=''>hilosophies</a>.</p>
